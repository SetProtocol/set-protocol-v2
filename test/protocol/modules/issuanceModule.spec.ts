...
describe("IssuanceModule", () => {
  ...
  let debtIssuance: IssuanceModule;
  ...
  before(async () => {
    ...
    debtIssuance = await deployer.modules.deployIssuanceModule(setup.controller.address);
  ...
  context("when IssuanceModule is initialized", async () => {
    ...
    context("when SetToken components do not have any rounding error", async () => {
      ...
      // tokenWithRoundingError instead of weth as a default position. This is to ensure the IssuanceModule behaves
