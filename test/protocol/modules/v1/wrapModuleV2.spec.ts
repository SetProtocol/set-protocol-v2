...
import { SetToken, WrapV2AdapterMock, WrapModuleV2 } from "@utils/contracts";
...
describe("WrapModule", () => {
  ...
  before(async () => {
    ...
    wrapAdapterMock = await deployer.mocks.deployWrapV2AdapterMock();
  ...
  describe("#constructor", async () => {
    ...
    async function subject(): Promise<WrapModuleV2> {
      return deployer.modules.deployWrapModuleV2(subjectController, subjectWETH);
    }
