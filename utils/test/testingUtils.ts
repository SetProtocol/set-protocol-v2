...
// This is test sandboxing for that allows for nested snapshots and can be used
// like a beforeEach statement. The same caveats about time noted in the comment above apply.
