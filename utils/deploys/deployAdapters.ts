...
import { UniSushiSplitter__factory } from "../../typechain/factories/UniSushiSplitter__factory";
...
export default class DeployAdapters {
  ...
  public async deployUniSushiSplitter(uniRouter: Address, sushiRouter: Address): Promise<UniSushiSplitter> {
    return await new UniSushiSplitter__factory(this._deployerSigner).deploy(uniRouter, sushiRouter);
  }
}
