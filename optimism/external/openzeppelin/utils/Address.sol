...
// Copy pasted from OZ v3.3.0 with an optimism patch sourced from:
...
// Optimsim does not support the `BALANCE` opcode. Balances are checked
...
library Address {
    ...
    /**
     *
     * @param {Address} _addressToQuery view public returns (uint)
     */
