...
contract PerpV2LeverageModule is ModuleBase, ReentrancyGuard, Ownable, SetTokenAccessible, IModuleIssuanceHookV2 {
    ...
    {        
        PerpV2.ActionInfo memory actionInfo = _createAndValidateActionInfo(
            _setToken,
            _baseToken,
            _baseQuantityUnits,
        ...
        (uint256 deltaBase, uint256 deltaQuote) = PerpV2.executeTrade(perpClearingHouse, actionInfo);
        ...
        returns (int256)
    {
        ...
        for(uint i = 0; i < positionLength; i++) {
            ...
            PerpV2.ActionInfo memory actionInfo = _createActionInfoNotional(
                _setToken,
            ...
            (, uint256 deltaQuote) = _isSimulation ? PerpV2.simulateTrade(perpQuoter, actionInfo) : PerpV2.executeTrade(perpClearingHouse, actionInfo);
    ...
    /**
     * @dev Construct the PerpV2.ActionInfo struct for trading. This method takes POSITION UNIT amounts and passes to
     ...
     *
     * @return PerpV2.ActionInfo           Instance of constructed PerpV2.ActionInfo struct
     */
    function _createAndValidateActionInfo(
        ...
        internal
        view
        returns(PerpV2.ActionInfo memory)
    {
    ...
    /**
     * @dev Construct the PerpV2.ActionInfo struct for trading. This method takes NOTIONAL token amounts and creates
