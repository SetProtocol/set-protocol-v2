...
/**
 * @title TradeSplitterExchangeAdapter
 * @author Set Protocol
 *
 * Exchange adapter for TradeSplitter that encodes trade data
 */
contract TradeSplitterExchangeAdapter {
     ...
     * Set state variables
     *
     * @param _tradeSplitter    address of the TradeSplitter contract
     */
    ...
    /**
     * Return calldata for TradeSplitter
     *
