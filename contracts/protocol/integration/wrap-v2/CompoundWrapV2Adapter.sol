 ...
 */
contract CompoundWrapV2Adapter is IWrapV2Adapter {
  ...
  /* ============ Constants ============ */
    ...
    address public constant override ETH_TOKEN_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
     ...
     */
     function getSpenderAddress(address /* _underlyingToken */, address _wrappedToken) external view override returns(address) {
